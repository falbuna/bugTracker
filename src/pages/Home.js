        ...
        isAuthenticated && (
            ...
            <div className={(sidebarOpen ? "lg:hidden" : "hidden")}>
                ...
                <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-cyan-700">
                    ...
                    <button className="ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" onClick={() => setSidebarOpen(!sidebarOpen)}>
                    ...
                    <div className="mt-6 pt-6">
                        ...
                        <a className="group flex items-center px-2 py-2 text-base font-medium rounded-md text-cyan-100 hover:text-white hover:bg-cyan-600" onClick={() => logout()}>
            ...
            <div className="hidden lg:flex lg:flex-shrink-0">
                ...
                <div className="flex flex-col flex-grow bg-cyan-700 pt-5 pb-4 overflow-y-auto">
                    ...
                    <div className="mt-6 pt-6">
                        ...
                        <a href="#" className="group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-cyan-100 hover:text-white hover:bg-cyan-600" onClick={() => logout()}>
                            <svg className="mr-4 h-6 w-6 text-cyan-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                            Logout
            ...
            <div className="flex-1 overflow-auto focus:outline-none" tabIndex="0">
                ...
                <button className="px-4 border-r border-gray-200 text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-cyan-500 lg:hidden" onClick={() => setSidebarOpen(!sidebarOpen)}>
                ...
                <div className="bg-white shadow">
                    ...
                    <div className="py-6 md:flex md:items-center md:justify-between lg:border-t lg:border-gray-200">
                        ...
                        <div className="flex items-center">
                            <img className="hidden h-16 w-16 rounded-full sm:block" src="/images/userlogo.png" alt="" />
                            <div>
                            <div className="flex items-center">
                                <img className="h-16 w-16 rounded-full sm:hidden" src="/images/userlogo.png" alt="" />
