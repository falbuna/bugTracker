...
function InputProject(){
    ...
    return(
        ...
        <div>
        <label for="email" class="block text-sm font-medium text-gray-700">Assigned to</label>
        <div class="mt-1">
        ...
        <label for="email" class="block text-sm font-medium text-gray-700">Project Name</label>
        <div class="mt-1">
        ...
        <label for="email" class="block text-sm font-medium text-gray-700">Project Description</label>
        <div class="mt-1">
            ...
            <button onClick={handleSaveProject} class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Submit
            </button>
        </div>
    )
